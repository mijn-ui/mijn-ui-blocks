  ...
  return (
    <KanbanCard className="group relative w-full">
      ...
      <button
        ...
        className="absolute -right-2 -top-6 flex size-5 items-center justify-center rounded-full border border-border bg-background opacity-0 transition-opacity hover:brightness-90 group-hover:opacity-100">
        <X size={12} />
      </button>
    </KanbanCard>
  );
